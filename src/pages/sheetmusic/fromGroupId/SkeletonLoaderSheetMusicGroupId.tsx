...
export default function SkeletonLoaderSheetMusicGroupId(props: { 
    resultsPerPage: number,
    page: number,
    author:string,
    title:string,
    groupId:string,
    callbackWhenFetched: (paginatedData : IPaginatedResultsAPI<ISheetMusicFromGroupAPI[]>) => void,
}) {

    useEffect(() => {
        let isDataFetched = false;
        let abortController = new AbortController();
        Get.sheetMusicsFromGroupId(props.groupId, abortController.signal, props.page, props.resultsPerPage, props.author, props.title)
            .then(json => {
                isDataFetched = true;
